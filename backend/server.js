      ...
      db.exec(`
        ...
        INSERT INTO bookings_new
          SELECT id, reference, trip_id, agency_id, passenger_name, passenger_phone,
                 passenger_email, passengers, total_price, commission_rate,
                 commission_amount, status, payment_status, payment_method,
                 transaction_id, boarding_status,
                 COALESCE(seat_numbers, NULL),
                 created_at
          FROM bookings;
        DROP TABLE bookings;
